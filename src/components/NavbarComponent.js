...
import { Navbar, NavbarBrand, Nav, Form, Button, NavLink } from 'reactstrap';
                ...
                <div class="container">
                    ...
                    <div id="navbarSupportedContent" class="collapse navbar-collapse">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item"><a href="/shop" class="nav-link text-uppercase font-weight-bold">Gallery</a></li>
